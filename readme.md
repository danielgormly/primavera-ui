...
Primavera is a spec-first component library with plain JS web component implementations. Spec is handwritten but llm-assisted & opinionated. Implementations are vibe-coded based on spec then tested by me & further refined.

Spec is currently relatively informal - markdown files with . Some implementation details are included or suggested. No automated tests currently.
