...
Primavera is a spec-first component library with plain JS web component implementations. Spec is handwritten, opinionated, and relatively informal - markdown files. Implementations are vibe-coded based on spec then tested by me & further refined.
